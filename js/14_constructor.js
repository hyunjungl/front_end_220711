...
//   => 자동차 공장에 실제로 만들어진 자동차 제품 => ex) 자동차 마다 색상, 크기, 최대 속도
...
let user03 = new User("seok", 30, "hbs30832@naver.com");
let user04 = new User("jeoncheol", 30, "js93@gmail.com");
...
//   => 상속 받는 객체에서만 사용 가능 => 상속하는 객체에서 호출 x

// Car의 프토토타입 메서드로 지정을 하면 car(인스턴스)에서 사용 가능
Car.prototype.chanageColor = function (color) {
  this.color = color;
};

car.chanageColor("blue");
console.log(car);
...
function Cat(name, age) {
  // this 바인딩
  // Animal을 호출하지만 this가 Cat를 가르키게 함
...
let player02 = new Player("hbs9312", "test02@gmail.com", "전사", 30, 400);
