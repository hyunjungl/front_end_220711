...
//실행된 나라의 시간
let hours = today.getHours(); //시간을 (0~23)을 반환
...
// console.log(today, yesterday.getHours());
...
today.setDate(today.getDate() + 365); //10일 더하기
console.log(today);

//Math : 수학 관련 프로퍼티와 메서드 제공
...
// function getLotto() {
//   let results = [];
//   if (!results.includes(randomNum)) results.push(randomNum);
//   while (results.length < 6) {
//     let randomNum = Math.floor(Math.random() * 45 + 1);
//     if (!results.incluedes(randomNum)) results.push(randomNum);
//   }
//   return results;
// }
