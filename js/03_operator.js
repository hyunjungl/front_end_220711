...
var score = 90; // 우항에 있는 90을 좌항의 scroe 변수에 할당
...
console.log(!(false && false)); // 드모르간 법칙 (not A) || (not B) => 둘다 트루면 false
console.log(!(2 < 1 || 2 < 3));
console.log(!(1 > 10 || 2 > 3));

// 문자열 연결 연산자 : 좌항과 우항의 문자열을 연결 => 템플릿 리터럴을 사용 권장
let str = "안녕하세요" + " 황보 석입니다.";
let age = 30;
let address = "인천";
...
// "황보석"과 30의 데이터 타입을 비교 => 값 비교 x => typeof
